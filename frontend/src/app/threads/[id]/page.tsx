...
import { Comment, MeResponse, ThreadDetail } from "@/types/Threadtypes";
...
export default function ThreadsDetailsPage() {
  ...
  async function handleDeleteComment(currentCommentIdToBeDeleted: string) {
    if (!currentCommentIdToBeDeleted) {
      toast.error("Invalid comment", {
        description: "Cannot delete this comment",
      });
      return;
    }
                  ...
                  >
                    <div className="mb-3 flex items-start justify-between gap-3">
                      ...
                      {isCommentAuthor && (
                        ...
                        //   disabled={
                        //     !comment.id || commentBeingDeletedId === comment.id
                        //   }
                        //   variant="ghost"
                        //   size="sm"
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                ...
                                permanently delete your comment from this
                                thread.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
